...
public class WebViewActivity extends AppCompatActivity {
    private static final String HOME_URL = "http://172.16.2.16/#!/";
    private static final String SIGNUP_URL = "http://172.16.2.16/#!/signup";
    private static final String USERLIST_URL = "http://172.16.2.16/#!/user-list";
                ...
                loginDialog.setPositiveButton("로그인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new LoadUserList().execute(
                                "http://172.16.1.16:52273/user/login",
